function logreg(id) {
  console.log("#" + id);
  if (id == "register") {
    $("#login").slideToggle('.p1');
    $("#register").slideToggle('.p3');
...
$("#hide").click(function () {
    $("#eye").toggleClass("fa-eye-slash", 1000);
});
...
$(document).ready(function () {
  $(".Navbartoggle").click(function () {
    ...
    $(".closebtn").click(function () {
      $(".navbar_header").animate({ width: "0%", right: "-70%" }),
    ...
    $(window).scroll(function () {
      $(this).scrollTop() > 110
        ? ($(".nav-stacked").fadeIn(), $(".nav-stacked ").addClass("affix"))
